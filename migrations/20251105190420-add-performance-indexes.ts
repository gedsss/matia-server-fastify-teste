...
async function indexExists(queryInterface: QueryInterface, table: string, index: string): Promise<boolean> {
...
export async function up(queryInterface: QueryInterface, Sequelize: typeof import('sequelize')) {
  // Índices EXISTENTES
...
export async function down(queryInterface: QueryInterface, Sequelize: typeof import('sequelize')) {
  const indices = [
