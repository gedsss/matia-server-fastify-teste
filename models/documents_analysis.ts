...
class DocumentsAnalysis extends Model<DocumentsAnalysisAttributes, DocumentsAnalysisCreationAttributes> implements DocumentsAnalysisAttributes {
    public id!: string;
    public conversation_id!: string;
    public document_id!: string;
    public analysis_type!: 'sumario' | 'analise_legal' | 'extracao_entidade' | null;
