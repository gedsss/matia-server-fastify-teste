...
import activityLogs, { ActivityLogsAttributes } from '../models/activity_logs.js'
...
export const createActivityLogs = async (request: FastifyRequest<{ Body: CreateBody }>, reply: FastifyReply) => {
  try {
...
export const getActivityLogsById = async (request: FastifyRequest<{ Params: Params }>, reply: FastifyReply) => {
  try {
...
export const updateActivityLogs = async (request: FastifyRequest<{ Body: UpdateBody, Params: Params }>, reply: FastifyReply) => {
  try {
    const { id } = request.params
    const [updatedRows] = await activityLogs.update(request.body, { where: { id } })
...
export const deleteActivityLogs = async (request: FastifyRequest<{ Params: Params }>, reply: FastifyReply) => {
  try {
    const { id } = request.params
