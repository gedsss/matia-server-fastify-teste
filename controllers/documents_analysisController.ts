...
export const createDocumentsAnalisys = async (request: FastifyRequest) => {
  try {
...
export const getDocumentsAnalisysById = async (request: FastifyRequest) => {
  try {
...
export const updateDocumentsAnalisys = async (request: FastifyRequest) => {
  try {
    const { id } = request.params as Params
